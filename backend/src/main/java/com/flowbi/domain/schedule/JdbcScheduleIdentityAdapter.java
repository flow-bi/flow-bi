...
final class JdbcScheduleIdentityAdapter {

  private final JdbcTemplate jdbcTemplate;

  JdbcScheduleIdentityAdapter(JdbcTemplate jdbcTemplate) {
    this.jdbcTemplate = jdbcTemplate;
  }

  void requireActiveActor(long actorId) {
  ...
  List<AttendeeCandidate> searchActiveUsers(String rawQuery) {
