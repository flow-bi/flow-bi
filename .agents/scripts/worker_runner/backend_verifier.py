"""Compatibility adapter for the Backend verifier CLI and imports."""
...
from worker_runner.verifiers.backend_client import (
    BackendVerifierClientError,
    request_backend_formatting,
    request_backend_verification,
)
from worker_runner.verifiers.backend_formatting import FormatterScope
from worker_runner.verifiers.backend_service import (
